...
car_img_2 = draw_initial_car(canvas, car2_Y, car2_X, filename2)
canvas.update()
...
# Calculate total vertical distance that needs to be traversed
distanceY_car2 = destination2_Y - car2_Y
if distanceY_car2 < 0:
    vertDirection2 = True  # Car needs to drive north
    distanceY_car2 = abs(distanceY_car2)  # Creates positive value
else:
...
# Calculate total horizontal distance that needs to be traversed
distanceX_car2 = destination2_X - car2_X
if distanceX_car2 < 0:
    horizDirection2 = True  # Car needs to drive left
    distanceX_car2 = abs(distanceX_car2)  # Creates positive value
else:
